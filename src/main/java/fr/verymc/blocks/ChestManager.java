...
public class ChestManager {
    ...
    public void autoSellForVeryChest() {
        ...
        for (Island island : IslandManager.instance.islands) {
            for (main.java.fr.verymc.blocks.Chest chest : island.getChests()) {
                try {
    ...
    public void placeChest(Player player, Location block, int type, ItemStack item, double price, Material stacked) {
        IslandManager.instance.getPlayerIsland(player).addChest(new main.java.fr.verymc.blocks.Chest(type, block, player.getUniqueId(), block.getChunk().getChunkKey(),
