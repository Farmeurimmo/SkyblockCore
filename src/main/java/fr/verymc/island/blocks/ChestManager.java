...
public class ChestManager {
    ...
    public void autoSellForVeryChest() {
        HashMap<main.java.fr.verymc.island.blocks.Chest, Double> reward = new HashMap<>();
        for (Island island : IslandManager.instance.islands) {
            for (main.java.fr.verymc.island.blocks.Chest chest : island.getChests()) {
                try {
        ...
        for (Entry<main.java.fr.verymc.island.blocks.Chest, Double> tosend : reward.entrySet()) {
    ...
    public main.java.fr.verymc.island.blocks.Chest getChestFromLoc(Location block) {
        for (Island island : IslandManager.instance.islands) {
            for (main.java.fr.verymc.island.blocks.Chest chest : island.getChests()) {
                if (chest.getBlock().getBlock().getLocation().equals(block)) {
                    return chest;
