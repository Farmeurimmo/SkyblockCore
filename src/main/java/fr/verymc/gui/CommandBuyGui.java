...
public class CommandBuyGui {
    ...
    public static void BuyCmd(String cmd, Player player) {
        ...
        if (cmd.contains("hat")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.hatprix, true);
        ...
        if (cmd.contains("fly")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.flyprix, true);
        ...
        if (cmd.contains("feed")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.feedprix, true);
        ...
        if (cmd.contains("craft")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.craftprix, true);
        ...
        if (cmd.contains("isrename")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.isrenameprix, true);
        ...
        if (cmd.contains("enchantement")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.enchantementprix, true);
        ...
        if (cmd.contains("sellall")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getName(), (double) Farm2WinGui.sellallprix, true);
