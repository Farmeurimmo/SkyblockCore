...
public class RankBuyGui {
    ...
    public static void BuyRank(String rank, Player player) {
        ...
        if (rank.contains("Légende")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getUniqueId(), (double) Farm2WinGui.legendeprix, true);
        ...
        if (rank.contains("Dieu")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getUniqueId(), (double) Farm2WinGui.dieuprix, true);
        ...
        if (rank.contains("Zeus")) {
            ...
            EcoAccountsManager.instance.RemoveFounds(player.getUniqueId(), (double) Farm2WinGui.zeusprix, true);
