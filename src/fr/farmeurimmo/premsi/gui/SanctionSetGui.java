...
public class SanctionSetGui {
	...
	public static void MakeSSGui(Player player, Player aaa) {
		...
		customf.setDisplayName("§6Purges §8| §7(clic)");
	...
	@SuppressWarnings("deprecation")
	public static void MakeBanGui(Player player, Player aaa) {
		
		User user = LuckPermsProvider.get().getUserManager().getUser(aaa.getName());
		String Grade = user.getCachedData().getMetaData().getPrefix().replace("&", "§");
		TNEAPI ecoAPI = TNE.instance().api();
		
        Inventory inv = Bukkit.createInventory(null, 27, "§6Menu des Bans");
		...
		ItemMeta customa = custom1.getItemMeta();
		customa.setDisplayName("§6KillAura §8| §7(clic)");
		custom1.setItemMeta(customa);
		
		ItemStack custom4 = new ItemStack(Material.WOODEN_SWORD, 1);
		ItemMeta customd = custom4.getItemMeta();
		customd.setDisplayName("§6CPS §8| §7(clic)");
		custom4.setItemMeta(customd);
		
		ItemStack custom5 = new ItemStack(Material.FEATHER, 1);
		ItemMeta custome = custom5.getItemMeta();
		custome.setDisplayName("§6Fly §8| §7(clic)");
		custom5.setItemMeta(custome);
		
		ItemStack custom6 = new ItemStack(Material.STICK, 1);
		ItemMeta customf = custom6.getItemMeta();
		customf.setDisplayName("§6Anti-Knockback §8| §7(clic)");
		custom6.setItemMeta(customf);
		
		ItemStack custom7 = new ItemStack(Material.GOLDEN_AXE, 1);
		ItemMeta customg = custom7.getItemMeta();
		customg.setDisplayName("§6Reach §8| §7(clic)");
		custom7.setItemMeta(customg);
		
		ItemStack custom8 = new ItemStack(Material.ARMOR_STAND, 1);
		ItemMeta customh = custom8.getItemMeta();
		customh.setDisplayName("§6Autres Cheats §8| §7(clic)");
		custom8.setItemMeta(customh);
		
		ItemStack custom9 = new ItemStack(Material.NAME_TAG, 1);
		ItemMeta customi = custom9.getItemMeta();
		customi.setDisplayName("§6Pseudo incorrect §8| §7(clic)");
		custom9.setItemMeta(customi);
		
		ItemStack custom10 = new ItemStack(Material.LEATHER, 1);
		ItemMeta customj = custom10.getItemMeta();
		customj.setDisplayName("§6Skin incorrect §8| §7(clic)");
		custom10.setItemMeta(customj);
		
		ItemStack custom12 = new ItemStack(Material.DIAMOND_CHESTPLATE, 1);
		ItemMeta customl = custom12.getItemMeta();
		customl.setDisplayName("§6Autres §8| §7(clic)");
	...
	@SuppressWarnings("deprecation")
	public static void MakePurgeGui(Player player, Player aaa) {
		
		User user = LuckPermsProvider.get().getUserManager().getUser(aaa.getName());
		String Grade = user.getCachedData().getMetaData().getPrefix().replace("&", "§");
		TNEAPI ecoAPI = TNE.instance().api();
		
        Inventory inv = Bukkit.createInventory(null, 27, "§6Menu des Purges");
		...
		ItemStack custom1 = new ItemStack(Material.WRITABLE_BOOK, 1);
		ItemMeta customa = custom1.getItemMeta();
		customa.setDisplayName("§6Dé mute §8| §7(clic)");
		custom1.setItemMeta(customa);
		
		ItemStack custom4 = new ItemStack(Material.ANVIL, 1);
		ItemMeta customd = custom4.getItemMeta();
		customd.setDisplayName("§6Dé ban §8| §7(clic)");
		custom4.setItemMeta(customd);
		
		ItemStack custom5 = new ItemStack(Material.NAME_TAG, 1);
		ItemMeta custome = custom5.getItemMeta();
		custome.setDisplayName("§6Dé ban-ip §8| §7(clic)");
		custom5.setItemMeta(custome);
		
		ItemStack custom6 = new ItemStack(Material.BEDROCK, 1);
		ItemMeta customf = custom6.getItemMeta();
		customf.setDisplayName("§6Purge des sanctions actuelles §8| §7(clic)");
		custom6.setItemMeta(customf);
