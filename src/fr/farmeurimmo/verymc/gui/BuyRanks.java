...
public class BuyRanks {
	...
	public static void BuyRank(String rank, Player player) {
	    ...
	    if(rank.contains("legende")) {
	    	...
	    	EcoAccountsManager.RemoveFounds(player, Farm2WinGui.legendeprix);
	    ...
	    if(rank.contains("dieu")) {
			...
			EcoAccountsManager.RemoveFounds(player, Farm2WinGui.dieuprix);
	    ...
	    if(rank.contains("zeus")) {
	    	...
	    	EcoAccountsManager.RemoveFounds(player, Farm2WinGui.zeusprix);
