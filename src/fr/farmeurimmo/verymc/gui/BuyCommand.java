...
public class BuyCommand {
	...
	public static void BuyCmd(String cmd, Player player) {
		...
		if(cmd.contains("hat")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.hatprix);
		...
		if(cmd.contains("fly")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.flyprix);
		...
		if(cmd.contains("feed")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.feedprix);
		...
		if(cmd.contains("craft")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.craftprix);
		...
		if(cmd.contains("isrename")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.isrenameprix);
		...
		if(cmd.contains("enchantement")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.enchantementprix);
		...
		if(cmd.contains("sellall")) {
			...
			EcoAccountsManager.RemoveFounds(player.getName(), Farm2WinGui.sellallprix);
