...
public class BuyRanks {
	...
	public static void BuyRank(String rank, Player player) {
	    ...
	    if(rank.contains("legende")) {
			...
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user " + player.getName() + " parent add legende");
	    ...
	    if(rank.contains("dieu")) {
			...
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user " + player.getName() + " parent add dieu");
	    ...
	    if(rank.contains("zeus")) {
			...
			Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "lp user " + player.getName() + " parent add zeus");
